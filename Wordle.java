public class Wordle {
    ...
    public static String chooseSecretWord(String[] dict) {
		int indexOfrandomWord = (int)(Math.random() * (dict.length));
        return dict[indexOfrandomWord];
    }
    ...
    public static boolean isAllGreen(char[] resultRow) {
        String allGrean = new String(resultRow);
		if(containsChar(allGrean, 'Y') || containsChar(allGrean, '_'))
            {
                return false;
            }
            else return true;
